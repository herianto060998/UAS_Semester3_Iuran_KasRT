...
<body class="hold-transition login-page">
    <div class="login-box">
        ...
        <div class="card">
            ...
            <p class="login-box-msg text-bold fs-2">Sistem Iuran Kas RT</p>
                ...
                <form action="" method="POST">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-4">
                            <button style="background-color: #72BDB6; border-color: white;" type="submit" name="submit" class="btn btn-primary btn-block">Masuk</button>
                        </div>
                    </div>
                </form>
            </div>
